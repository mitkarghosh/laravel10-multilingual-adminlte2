@extends('email_templates.layouts.app_email')
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td>
				@lang('custom.message_thank_you_for_placing_an_order') @lang('custom.message_below_are_the_order_details')<br><br>
				@lang('custom.label_order_no'): {{$getOrderData['unique_order_id']}}<br><br>
				...
				@if ($getOrderData['delivery_type'] == 'Delivery')
				...
				@if ($getOrderData['delivery_company'] != null)
					{!!$getOrderData['delivery_company'].', '!!}
				@endif
				@if ($getOrderData['delivery_door_code'] != null)
					{{$getOrderData['delivery_door_code'].', '}}
				@endif
				{{$getOrderData['delivery_street'].', '}}
				@if ($getOrderData['delivery_floor'] != null)
					{{$getOrderData['delivery_floor'].', '}}
				@endif
				{{$getOrderData['delivery_post_code'].' '.$getOrderData['delivery_city']}}
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
