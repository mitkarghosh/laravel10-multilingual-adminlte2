@extends('email_templates.layouts.app_email')
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td style="color:#141414; font-size:15px;"> @lang('custom_admin.label_hello') {{ $user->full_name }},</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td>@lang('custom_admin.message_new_admin_email')</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="5">
					<tr>
						<td width="25%" align="left" valign="top" style="color:#141414; font-weight:bold; line-height:20px;">@lang('custom_admin.lab_invoice_email')</td>
					...
					<tr>
						<td width="25%" align="left" valign="top" style="color:#141414; font-weight:bold; line-height:20px;">@lang('custom_admin.lab_password')</td>
						<td width="2%" align="left" valign="top" style="line-height:20px;">:</td>
