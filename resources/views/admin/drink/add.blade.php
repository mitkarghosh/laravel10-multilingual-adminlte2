...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.'.\App::getLocale().'.drink.list')}}"><i class="fa fa-glass"></i> @lang('custom_admin.lab_drink_list')</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.'.\App::getLocale().'.drink.addsubmit'],
                                    'name'  => 'addDrinkForm',
                                    'id'    => 'addDrinkForm',
                                    'files' => true,
		                            'novalidate' => true)) }}
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('admin.'.\App::getLocale().'.drink.list') }}" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.btn_cancel')</a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
