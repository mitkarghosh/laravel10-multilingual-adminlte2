...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.'.\App::getLocale().'.drink.list')}}"><i class="fa fa-glass"></i>@lang('custom_admin.lab_drink_list')</a></
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.'.\App::getLocale().'.drink.editsubmit', $details["id"]],
                                    'title'  => 'updateDrinkForm',
                                    'id'    => 'updateDrinkForm',
                                    'files' => true,
		                            'novalidate' => true)) }}
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span>@lang('custom_Admin.lab_file_dimension') {{AdminHelper::ADMIN_DRINK_THUMB_IMAGE_WIDTH}}px X {{AdminHelper::ADMIN_DRINK_THUMB_IMAGE_HEIGHT}}px</span>
                                @if($details->image)
                                <div class="form-group">						
							        @if(file_exists(public_path('/uploads/drink/'.$details->image))) 
								        <embed src="{{ asset('uploads/drink/'.$details->image) }}"  height=50 />
							        @endif						
					           </div>
					           @endif
                            </div>
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('admin.'.\App::getLocale().'.drink.list').'?page='.$data['pageNo'] }}" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.btn_cancel')</a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
