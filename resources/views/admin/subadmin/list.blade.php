            ...
            <div class="box">
                <div class="box-header">
					...
					{{ Form::open(array(
									'method' => 'GET',
									'class' => '',
									'route' =>  ['admin.'.\App::getLocale().'.subAdmin.list'],
						...
						<div class="col-md-12">
							<div class="col-md-3">
								...
								<a href="{{ route('admin.'.\App::getLocale().'.subAdmin.list') }}" class="btn btn-default"><i class="fa fa-refresh"></i></a>
							</div>
						</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="pull-right page_of_margin m-l-20">
                        <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.subAdmin.show-all')}}">@lang('custom_admin.label_show_all')</a>
                      </div>
