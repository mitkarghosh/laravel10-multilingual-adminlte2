            ...
            <div class="box">
				...
				<div class="box-header with-border">
                    ...
                    {{ Form::open(array(
                                      'method' => 'GET',
                                      'class' => '',
                                      'route' =>  ['admin.'.\App::getLocale().'.product.list'],
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <a href="{{ route('admin.'.\App::getLocale().'.product.list') }}" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.lab_order_reset')</a>
                        </div>
                        <!-- Filter section end -->                        
                      </div>
                    {!! Form::close() !!}
                    ...
                    @if(count($list) > 0)
                      ...
                      <tr>
						...
						<td>{{ $row->local[1]->local_title }}</td>
                          ...
                          <td class="text_align_center" width="200">
                          <a href="{{ route('admin.'.\App::getLocale().'.product.edit', [$row->id]) }}" title="@lang('custom_admin.lab_edit')" class="btn btn-info btn-sm">
                              <i class="fa fa-pencil" aria-hidden="true"></i>
                            </a>
                            &nbsp;
                          <a  href="{{ route('admin.'.\App::getLocale().'.product.copy', [base64_encode($row->id)]) }}" title="Copy" data-href="" class="btn btn-primary btn-sm"><i class="fa fa-copy" aria-hidden="true"></i></a>  
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="pull-right page_of_margin m-l-20">
                        <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.product.show-all').'?'.http_build_query(['searchText' => $searchText, 'category' => $category])}}">@lang('custom_admin.label_show_all')</a>
                      </div>
