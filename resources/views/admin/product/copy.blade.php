                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group is_menu_show total-menu-item" data-count="{{count($addon_list)}}"  style="display: none;">
                                    ...
                                    @php
                                    $g = 1; $h = 0;
                                    if (count($details->productMenuTitles) > 0 && $is_addon_id) {
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="collapse-type-heading">
                                                        <div class="col-md-4">                                                       
                                                            <select required class="form-control main-addon-selection" data-index="{{$keyMenuTitle}}" name="dropdown[{{$keyMenuTitle}}][main_addon]">
                                                                <option value="">@lang('custom_admin.lab_select')</option>
                                                                @foreach($addon_list as $list)
                                                                
                                                                    <option value="{{$list->id}}" data-id="{{$list->id}}" @if($valMenuTitle->addon_id==$list->id) selected  @endif data-de="{{$list->de_title }}" data-en="{{$list->en_title }}"> @if(App::getLocale() == 'de')  {{$list->de_title }} @else {{$list->en_title}}  @endif </option>
                                                            ...
                                                            <div class="addSubDropdownField_{{$keyMenuTitle}}">                                                
                                                                @foreach ($valMenuTitle->menuValues as $keyValue => $valValue)
                                                                    ...
                                                                    <div class="col-md-2 checkbox-sub-div">
                                                                        ...
                                                                        <input class="" type="hidden" value="{{$valValue->sub_addon_id}}" name="dropdown[{{$keyMenuTitle}}][value_sub_addon_id][]">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select required class="form-control main-addon-selection" data-index="0" name="dropdown[0][main_addon]">
                                                            ...
                                                            @foreach($addon_list as $list)
                                                                ...
                                                                <option value="{{$list->id}}" data-id="{{$list->id}}" data-de="{{$list->de_title }}" data-en="{{$list->en_title }}"> @if(App::getLocale() == 'de')  {{$list->de_title }} @else {{$list->en_title}}  @endif </option>
...
$(document).on('change','.main-addon-selection',function(){ 
            ...
            $(document).find('.allsub-menus option').each(function(){ 
                ...
                if(thisvals && thisvals==Number($(this).data('parent'))){
