        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
                                'method'=> 'POST',
                                'class' => '',
                                'route' => ['admin.'.\App::getLocale().'.role.editsubmit', $id],
                                    'title'  => 'editRoleForm',
                                    'id'    => 'editRoleForm',
                                'files' => true,
                                'novalidate' => true)) }}
                            ...
                            <div class="col-md-12 individual_section">
                                ...
                                <div class="permission-content section_class">
                                    ...
                                    @foreach($groupRow as $row)
                                        ...
                                        if (in_array($row['role_page_id'], $existingPermission)) $individualCheckedCount++;
                                        ...
                                        <li>
                                            <input type="checkbox" name="role_page_ids[]" value="{{$row['role_page_id']}}" @if(in_array($row['role_page_id'], $existingPermission))checked @endif data-page="{{ $group }}" data-path="{{ $row['path'] }}" data-class="{{ $groupClass }}" data-listIndex="{{$listIndexClass}}" class="setPermission {{ $groupClass }} {{ $subClass }} selectDeselectAll"> <span>{{ $labelName }}</span>
                                        </li>
                ...
                <div class="box-footer">
                    <button type="submit" id="editRole" class="btn btn-primary" title="@lang('custom_admin.btn_submit')">@lang('custom_admin.btn_submit')</button>
                    <a href="{{ route('admin.'.\App::getLocale().'.role.list').'?page='.$pageNo}}" title="@lang('custom_admin.btn_cancel')" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.btn_cancel')</a>
                </div>
                </form>
            </div>
        </div>
