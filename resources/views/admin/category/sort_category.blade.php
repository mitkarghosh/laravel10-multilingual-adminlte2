    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                @if ($list)
                    <p>@lang('custom_admin.message_category_ascending').</p>
                    <div class="well">
    ...
    $(function() {
        ...
        $('.dd').nestable({
            ...
            dropCallback: function(details) {    
                ...
                var data_id = window.location.hostname + '.nestable_SchiffBinningen';
                ...
                if (drag_data === storage_data) {
                    ...
                    // post data by ajax
                    $.ajax({
                        url: '{{ route("admin.".\App::getLocale().".category.save-sort-category") }}',
                        type: 'post',
                        data: {
