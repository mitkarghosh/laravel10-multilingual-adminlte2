            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    {{ Form::open(array(
                                      'method' => 'GET',
                                      'class' => '',
                                      'route' =>  ['admin.'.\App::getLocale().'.order.show-all'],
                                      'id' => '',
                                      'novalidate' => true)) }}                    
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                              ...
                              @if($purchaseDate == '')
                                <p class="lab_report_download_text" style="color:red; display:none">@lang('custom_admin.lab_report_download_text')</p>
                              @endif
                          </div>
                        </div>
                        <div class="col-md-4">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          ...
                          <a href="{{ route('admin.'.\App::getLocale().'.order.show-all') }}" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.lab_order_reset')</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-right page_of_margin">
                                <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.order.list').'?'.http_build_query(['purchase_date' => $purchaseDate, 'searchText' => $searchText, 'payment_method' => $paymentMethod, 'payment_status' => $paymentStatus, 'status' => $status])}}">@lang('custom_admin.label_pageview')</a>
                            </div>
                        </div>
                    </div>
				</div>
