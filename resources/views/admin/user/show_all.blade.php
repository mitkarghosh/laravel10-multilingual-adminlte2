                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        {{ Form::open(array(
                                        'method' => 'GET',
                                        'class' => 'display_table',
                                        'route' =>  ['admin.'.\App::getLocale().'.user.show-all'],
                                        'id' => 'searchuserForm',
                                        'novalidate' => true)) }}
                          {{ Form::text('searchText', (isset($searchText)) ? $searchText:null, array(
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ route('admin.'.\App::getLocale().'.user.show-all') }}" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                            </div>
                        {!! Form::close() !!}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-right page_of_margin">
                                <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.user.list')}}">@lang('custom_admin.label_pageview')</a>
                            </div>
                        </div>
                    </div>
                </div>
