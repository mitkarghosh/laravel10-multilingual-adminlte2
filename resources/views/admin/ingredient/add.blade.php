        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.'.\App::getLocale().'.ingredient.addsubmit'],
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('admin.'.\App::getLocale().'.ingredient.list') }}" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.btn_cancel')</a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
