                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th>@lang('custom_admin.lab_review_on')</th>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="pull-left page_of_margin">
                        {{ AdminHelper::paginationMessage($reviews) }}
                      </div>
                    </div>
                    <div class="col-sm-9">
                      <div class="pull-right page_of_margin m-l-20">
                        <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.review.show-all')}}">@lang('custom_admin.label_show_all')</a>
                      </div>
