                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        {{ Form::open(array(
                                        'method' => 'GET',
                                        'class' => 'display_table',
                                        'route' =>  ['admin.'.\App::getLocale().'.tag.list'],
                                        'id' => 'searchTagForm',
                                        'novalidate' => true)) }}
                          {{ Form::text('searchText', (isset($searchText)) ? $searchText:null, array(
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ route('admin.'.\App::getLocale().'.tag.list') }}" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                            </div>
                        {!! Form::close() !!}
                        </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="pull-right page_of_margin m-l-20">
                        <a class="btn btn-primary" href="{{route('admin.'.\App::getLocale().'.tag.show-all')}}">@lang('custom_admin.label_show_all')</a>
                      </div>
