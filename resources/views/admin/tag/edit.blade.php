        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.'.\App::getLocale().'.tag.editsubmit', $details["id"]],
                                    'title'  => 'editTagForm',
                                    'id'    => 'editTagForm',
                                    'files' => true,
		                            'novalidate' => true)) }}
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @if($details->image)
                                <div class="form-group">						
                                    @if(file_exists(public_path('/uploads/tag/'.$details->image))) 
                                        <embed src="{{ asset('uploads/tag/'.$details->image) }}"  height=50 />
                                    @endif						
                               </div>
                               @endif
                            </div>
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('admin.'.\App::getLocale().'.tag.list').'?page='.$data['pageNo'] }}" title="@lang('custom_admin.btn_cancel')" class="btn btn-block btn-default btn_width_reset">@lang('custom_admin.btn_cancel')</a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
