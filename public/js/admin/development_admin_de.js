...
$(document).ready(function() {
    ...
    $("#updateAdminPassword").validate({
        ...
        messages: {
            current_password: {
                ...
                // minlength: "Min. 8 Zeichen, alphanumerisch, Sonderzeichen & ein Großbuchstabe"
            },
            password: {
                required: "Bitte Passwort eingeben",
                // valid_password: "Min. 8 Zeichen, alphanumerisch, Sonderzeichen & ein Großbuchstabe"
            },
            confirm_password: {
                required: "Bitte Passwort bestätigen",
                // valid_password: "Min. 8 Zeichen, alphanumerisch, Sonderzeichen & ein Großbuchstabe",
                equalTo: "Bestätigungs-Passwort sollte gleich dem neuen Passwort sein",
            }
        },
        submitHandler: function(form) {
            form.submit();
    ...
    $("#addUserProfile").validate({
        ...
        messages: {
            full_name: {
                ...
                maxlength: "Der Name darf nicht länger als 255 Zeichen sein"
            },
    ...
    $("#addCategoryForm").validate({
        ...
        messages: {
            title: {
                required: "Bitte Titel eingeben",
                minlength: "Titel sollte mindestens 2 Zeichen lang sein",
                maxlength: "Der Titel sollte nicht mehr als 255 Zeichen umfassen"
            },
            title_de: {
                required: "Bitte Titel eingeben",
                minlength: "Titel sollte mindestens 2 Zeichen lang sein",
    ...
    $("#addDrinkForm").validate({
        ...
        messages: {
            ...
            price: {
                required: "Bitte Preis eingeben",
                minlength: "Bitte gültigen Preis eingeben"
            },
            image: {
                required: "Bitte Bild auswählen",
    ...
    $("#addProductForm").validate({
        ...
        messages: {
            ...
            // description_en: {
            //     required: "Bitte Beschreibung eingeben",
            //     minlength: "Bitte geben Sie 10 Zeichen ein"
            // },
            // description_de: {
            //     required: "Bitte Beschreibung eingeben",
            //     minlength: "Bitte geben Sie 10 Zeichen ein"
            ...
            // },
            // 'tags[]': {
            //     required: "Bitte Tag(s) auswählen",
            // },
        },
        errorPlacement: function(error, element) {
    ...
    $("#addPinCodeForm").validate({
        ...
        messages: {
            ...
            minimum_order_amount: {
                required: "Bitte geben Sie den Mindestbestellpreis ein",
                valid_min_amount: "Bitte gültigen Betrag eingeben"
            },
            // delivery_charge: {
            //     required: "Bitte lieferung aufladen eingeben",
            //     valid_min_amount: "Bitte gültigen Betrag eingeben"
            // },
        },
        errorPlacement: function(error, element) {
    ...
    $("#updateSiteSettingsForm").validate({
        ...
        messages: {
            from_email: {
                required: 'Bitte "von"-E-Mail eingeben',
            },
            to_email: {
                required: 'Bitte "an"-E-Mail eingeben',
            },
            order_email: {
                required: "Bitte Bestell-E-Mail eingeben",
            },
            website_title: {
                required: "Bitte Webseiten-Titel eingeben",
                minlength: "Webseiten-Titel sollte mindestens 2 Zeichen lang sein",
                maxlength: "Der Titel der Webseite darf nicht mehr als 255 Zeichen lang sein."
            },
            website_link: {
                required: "Bitte Webseiten-Link eingeben",
                minlength: "Webseiten-Link sollte mindestens 2 Zeichen lang sein",
                maxlength: "Webseiten-Link darf nicht mehr als 255 Zeichen lang sein"
            },
            // minimum_order_amount: {
            //     required: "Bitte geben Sie den Mindestbestellpreis ein",
            //     valid_amount: "Bitte gültigen Betrag eingeben"
            // },
            footer_address: {
                required: "Bitte Adresse in der Fußzeile eingeben",
            },
            min_delivery_delay_display: {
                required: "Bitte geben Sie die minimale Lieferverzögerungszeit ein",
            }
        },
        errorPlacement: function(error, element) {
            // if ($(element).attr('id') == 'minimum_order_amount') {
    ...
    $("#updateCmsForm").validate({
        ...
        messages: {
            ...
            // },
            meta_title: {
                required: "Bitte Meta-Titel eingeben"
            },
            meta_keyword: {
                required: "Bitte Meta-Schlüsselwort eingeben"
            },
            meta_description: {
                required: "Bitte Meta-Beschreibung eingeben"
            },
        },
        submitHandler: function(form) {
            form.submit();
    ...
    $("#createRoleForm").validate({
        ...
        messages: {
            name: {
                required: "Bitte Rollennamen eingeben",
                minlength: "Der Rollenname sollte mindestens 2 Zeichen lang sein",
                maxlength: "Der Rollenname sollte mindestens 2 Zeichen lang sein"
            }
        },
        submitHandler: function(form) {
            form.submit();
    ...
    $("#editRoleForm").validate({
        ...
        messages: {
            name: {
                required: "Bitte Rolle eingeben",
                minlength: "Die Rolle sollte aus mindestens 2 Zeichen bestehen",
                maxlength: "Die Rolle darf nicht länger als 255 Zeichen sein"
            }
        },
        submitHandler: function(form) {
            form.submit();
    ...
    $("#addSubAdminForm").validate({
        ...
        messages: {
            first_name: {
                required: "Bitte Vorname eingeben",
                minlength: "Der Vorname sollte mindestens 2 Zeichen lang sein",
                maxlength: "Der Vorname darf nicht mehr als 255 Zeichen lang sein"
            },
            last_name: {
                required: "Bitte Nachname eingeben",
                minlength: "Der Nachname sollte mindestens 2 Zeichen lang sein",
                maxlength: "Der Nachname darf nicht mehr als 255 Zeichen lang sein."
            },
            email: {
                required: "Bitte E-Mail eingeben",
            },
            phone_no: {
                required: "Bitte Kontaktnummer eingeben",
            },
            'role[]': {
                required: "Bitte Rolle auswählen",
            },
        },
        errorPlacement: function(error, element) {
            if (element.hasClass('select2') && element.next('.select2-container').length) {
    ...
    // alert();
     ...
     $(document).find('#addAddonProductNew').find('input').each(function(){
         ...
         if (typeof attr !== 'undefined' && attr !== false) {
             if($(this).val().trim()==''){
                 error='<label  class="error errorfeild">Dieses Feld ist erforderlich.</label>';
                 $(this).after(error);
                 formvalue.push(1);
             }
         }
