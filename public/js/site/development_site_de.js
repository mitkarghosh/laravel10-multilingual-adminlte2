...
}, 'Bitte gültigen Packungswert eingeben');
...
}, 'Bitte gültigen Mindestbetrag eingeben');
...
}, 'Muss größer als das Startdatum sein');
...
$(document).ready(function() {
    ...
    $("#registrationForm").validate({
        ...
        messages: {
           first_name: {
            ...
            confirm_password: {
                ...
                // valid_password: "Min. 8 Zeichen, alphanumerisch, Sonderzeichen & ein Großbuchstabe",
                equalTo: "Das Passwort sollte dasselbe wie das erstellte Password sein",
            },
            agree: {
                required: "Bitte Allgemeine Geschäftsbedingungen auswählen",
            },
        },
        ...
        submitHandler: function(form) {
            ...
            if (response.length == 0) {     // recaptcha failed validation
                $('#recaptcha-error').html('Bitte vergewissern Sie sich, dass Sie ein Mensch sind');
    ...
    $("#personalDetails").validate({
        ...
        messages: {
            nickname: {
                required: "Bitte Nickname eingeben",
            },
            title: {
                required: "Bitte Titel auswählen",
            },
            first_name: {
            ...
            login_language: {
                required: "Bitte wählen Sie die Anmeldesprache",
            },
            email: {
                required: "Bitte E-Mail eingeben",
                valid_email: "Bitte gültige E-Mail eingeben",
            },
            phone_no: {
                required: "Bitte Kontaktnummer eingeben",
                valid_only_number: "Bitte Kontaktnummer ohne Landesvorwahl eingeben"
            },
            dob: {
                required: "Bitte wählen Sie Ihr Geburtsdatum",
            },
        },
        errorPlacement: function(error, element) {
            error.insertAfter(element);
            ...
            if($(this).val()){
                if($('.profile-update-form').length){
                    ...
                    if(phoneNo.includes("+")==false){ 
                        $(this).after("<div class='c_code_error'>Bitte geben Sie die Kontaktnummer mit Ländervorwahl ein.</div>")
                    }
                }
            }
     })
    ...
    $("#addAddressForm").validate({
        ...
        messages: {
            ...
            // },
            street: {
                required: "Bitte Straße und Hausnummer eingeben",
            },
            // floor: {
            ...
            addressAlias: {
                required: "Bitte wählen Sie den Adresstyp",
            },
            customAlias: {
                required: "Bitte geben Sie Ihren eigenen Aliasnamen ein",
            },            
        }, errorPlacement: function(error, element) {
            error.insertAfter(element);
        },
    ...
    $("#orderReviewForm").validate({
        ...
        messages: {
            food_quality: {
                required: "Bitte bewerten Sie die Lebensmittelqualität",
            },
            delivery_time: {
                required: "Bitte bewerten Sie die Lieferzeit",
            },
            driver_friendliness: {
                required: "Bitte bewerten Sie die Freundlichkeit der Fahrer",
            },
            // short_review: {
            //     required: "Bitte hinterlassen Sie eine kurze Bewertung",
            // },
        }, errorPlacement: function(error, element) {
            error.insertAfter(element);
        },
   ...
   /**
    ...
    $('.delete_address').on('click', function () {
        swal.fire({
			...
			text: 'Sind Sie sicher, dass Sie diese Adresse löschen möchten?',
            icon: 'warning',
    ...
    $("#pinCodeForm").validate({
        ...
        messages: {
            pin_code: {
                required: "Bitte postleizahl eingeben",
            },
        },
        submitHandler: function(form) {
            // $('body').addClass('clicked');
    ...
    $("#placeOrderForm").validate({
        ...
        messages: {
            ...
            addressAlias: {
                required: "Bitte Adresse auswählen",
            },
            delivery_address: {
                required: "Bitte fügen Sie eine Adresse hinzu",
            },
            // checkout_message: {
    ...
    $("#guestCheckoutForm").validate({
        ...
        messages: {
            delivery_date: {
                required: "Bitte wählen Sie das Lieferdatum",
            },
            delivery_time: {
                required: "Bitte wählen Sie die Lieferzeit",
            },
            full_name: {
                required: "Vorname & Nachname eingeben",
            },
            phone_no: {
                required: "Bitte Kontaktnummer eingeben",
            },
...
function getSelectedAddressWiseDeliveryCharge(selectedAddressId) {
    ...
    if (selectedAddressId != '') {
        ...
        swal.fire({
            text: 'Etwas ist schief gelaufen, bitte versuchen Sie es später noch einmal.',
            icon: 'error',
            allowOutsideClick: false,
            confirmButtonColor: '#1279cf',
            showCancelButton: false,
